package com.mashup.presentation.home.guide.model
...
enum class Alien(
    ...
    BLUE(
        alienName = "코아리안",
        alienImageSrc = R.drawable.img_alien_blue,
    ...
    ORANGE(
        alienName = "싸크라니스",
        alienImageSrc = R.drawable.img_alien_orange,
    ...
    MINT(
        alienName = "키키우스",
        alienImageSrc = R.drawable.img_alien_mint,
    ...
    GREEN(
        alienName = "스콜라리스",
        alienImageSrc = R.drawable.img_alien_green,
    ...
    PINK(
        alienName = "마스케리안",
        alienImageSrc = R.drawable.img_alien_pink,
